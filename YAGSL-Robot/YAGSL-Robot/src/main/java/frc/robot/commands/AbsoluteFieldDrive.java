...
public class AbsoluteFieldDrive extends CommandBase
{
  ...
  public void execute()
  {
    ...
    ChassisSpeeds desiredSpeeds = swerve.getTargetVelocities(
      vX.getAsDouble(),
      vY.getAsDouble(),
      new Rotation2d(heading.getAsDouble(), 0)
      );

    // Limit velocity to prevent tippy
    Translation2d translation = SwerveController.getTranslation2d(desiredSpeeds);
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldRelativeVelocity(), swerve.getPose(),
                                           Constants.DriveConstants.LOOP_TIME, Constants.PhysicalConstants.ROBOT_MASS, List.of(Constants.PhysicalConstants.PHYS_WRIST),
